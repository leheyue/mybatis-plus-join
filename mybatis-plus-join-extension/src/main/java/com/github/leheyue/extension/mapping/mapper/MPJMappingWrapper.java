...
public class MPJMappingWrapper {
    ...
    public MPJMappingWrapper(String first, String select, com.github.leheyue.annotation.Apply[] applys,
                             com.github.leheyue.annotation.Condition[] conditions, String last, String orderByAsc, String orderByDesc) {
        ...
        if (this.hasApply) {
            ...
            for (com.github.leheyue.annotation.Apply apply : applys) {
        ...
        if (this.hasCondition) {
            ...
            for (com.github.leheyue.annotation.Condition condition : conditions) {
    ...
    private SqlKeyword convert(com.github.leheyue.annotation.enums.SqlKeyword sqlKeyword) {
