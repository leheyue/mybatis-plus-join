package com.github.leheyue.injector;
...
import com.github.leheyue.adapter.v3431.AbstractMethodV3431;
import com.github.leheyue.method.*;
import com.github.leheyue.toolkit.MPJTableMapperHelper;
import com.github.leheyue.toolkit.TableHelper;
import com.github.leheyue.toolkit.VersionUtils;
import com.github.leheyue.toolkit.reflect.GenericTypeUtils;
...
public class MPJSqlInjector extends DefaultSqlInjector {
    ...
    private List<AbstractMethod> getWrapperMethod() {
        List<AbstractMethod> list = new ArrayList<>();
        list.add(new com.github.leheyue.method.mp.Delete());
        list.add(new com.github.leheyue.method.mp.SelectOne());
        list.add(new com.github.leheyue.method.mp.SelectCount());
        list.add(new com.github.leheyue.method.mp.SelectMaps());
        list.add(new com.github.leheyue.method.mp.SelectMapsPage());
        list.add(new com.github.leheyue.method.mp.SelectObjs());
        list.add(new com.github.leheyue.method.mp.SelectList());
        list.add(new com.github.leheyue.method.mp.SelectPage());
        list.add(new com.github.leheyue.method.mp.Update());
        return list;
    }
